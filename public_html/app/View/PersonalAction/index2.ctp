...
<div id="personalActions" ng-app="personalActionsApp">
	...
	<div ng-controller="PersonalActionsController" ng-init="initialize()">
		...
		<h3 ng-show="turn.t.status == 1">Submissions for this turn have ended</h3>
		...
		<div ng-show="selectedCharacter && turn.t.status == 0">
			...
			<div>
				<table class="actiontable">
					<tr ng-show="selectedCharacter.Business.length > 0">
						<th>Action #1</th>
						<td>
					...
					<tbody ng-show="selectedSettlement">
						...
						<tr>
							<th>Comments</th>
							<td><textarea ng-model="selectedComment1" rows="3" cols="50"></textarea>
						</tr>
					</tbody>
					...
					<tbody ng-show="details.civil_service == 1">
						...
						<tr ng-show="details.quadrivium == 1">
							<th>Action #2</th>
							<td>
