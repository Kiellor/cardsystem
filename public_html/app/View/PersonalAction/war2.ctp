	...
	<div ng-controller="WarActionsController" ng-init="initialize()">
		...
		<tr ng-repeat="c in characters">
			...
			<th>
				...
				<img src="/images/KR_run_G200.png" ng-hide="c.War.run == 1" ng-click="run(c)"/>
			</th>
			<th>
				<img src="/images/KR_hide_200.gif" ng-show="c.War.hide == 1"/>
				<img src="/images/KR_hide_G200.png" ng-hide="c.War.hide == 1" ng-click="hide(c)"/>
			</th>
			<th>
				<img src="/images/KR_fight_200.gif" ng-show="c.War.fight == 1"/>
				<img src="/images/KR_fight_G200.png" ng-hide="c.War.fight == 1" ng-click="fight(c)"/>
			</th>
